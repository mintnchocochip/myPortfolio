  ...
  theme: {
    ...
    extend: {
      ...
      dropShadow: {
        ...
        'enigma-glow': [
          // Glow for Enigma25 text in Login Page by Amiitesh
          '0 0 10px #1cd41c',
          '0 0 20px #1cd41c',
          '0 0 30px #1cd41c',
          '0 0 40px #1cd41c'
      ...
      keyframes: {
        // Keyframes for the login page by Amiitesh
        border: {
          '0%': {
        ...
        glow: {
          '0%, 100%': {
            textShadow:
              '0 0 10px #1cd41c, 0 0 20px #1cd41c, 0 0 30px #1cd41c, 0 0 40px #1cd41c'
          },
          '50%': {
            textShadow:
              '0 0 20px #1cd41c, 0 0 30px #1cd41c, 0 0 40px #1cd41c, 0 0 50px #1cd41c'
          }
        },
        float: {
          '0%, 100%': {
