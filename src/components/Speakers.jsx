  ...
  return (
    <>
      ...
      <Speaker
        ...
        values={{
          "Basics of Binary Exploitation": "Understanding and exploiting binary vulnerabilities",
          "Basic Tools for Analysis": "Using gdb, checksec, readelf, and ROPgadget",
          "Analyzing a Binary": "Extracting insights using security tools",
          "Overflows": "Exploiting buffer, integer, and stack overflows",
          "Formatting Vulnerabilities": "Attacking printf-style format string bugs",
